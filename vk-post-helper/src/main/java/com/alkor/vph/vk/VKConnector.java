...
public class VKConnector {
    ...
    public List<Group> searchGroups(String query, int count, String token) throws IOException, InterruptedException {
    ...
    public List<Long> getGroupMembers(long groupId, int count, String token) throws IOException, InterruptedException {
    ...
    public WallPostResult wallPost(Long gid, Post post, Captcha captcha, String token) throws IOException, InterruptedException {
